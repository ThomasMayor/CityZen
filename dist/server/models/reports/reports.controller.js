...
exports.reportController = {
    insert: function (req, res) {
        ...
        report.save(function (err, newreport) {
            ...
            console.dir(user_1.userScore.compute(req.authUser));
            req.authUser.score = user_1.userScore.compute(req.authUser);
            console.log('trying to save', req.authUser);
            req.authUser.save(function (err, doc) {
                if (err) {
                    return helper_controller_1.helperController.handleError(req, res, "Impossible de sauver l'utilisateur " + err + " " + req.authUser.score);
                }
